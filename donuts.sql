...
insert into product values(null, 'プレーンクラシック（5個入り）', 1500,'オーソドックスなチョコレートの美味しさを味わえる一品です。香ばしいコーヒーとの相性も抜群で、おしゃれなカフェスタイルを演出し、食卓を華やかに彩ります。');
insert into product values(null, '【新作】サマーシトラス（5個入り）', 1600,'レモンをトッピングしたドーナツのスタックです。ふんわりとした生地と甘さ控えめのグレーズが特徴で、爽やかなレモンの風味がアクセントとなっています。見た目にも美しく、特別な日のデザートやティータイムにぴったりの一品です。');
insert into product values(null, 'ストロベリークラッシュ（5個入り）', 1800,'バレンタインデーにぴったりのドーナツは、カラフルなスプリンクルで飾られた甘美なスイーツです。愛のメッセージを込めたこのドーナツは、特別な日の贈り物やパーティーに最適で、見た目にも楽しませてくれます。しっとりとした生地と甘さ控えめなグレーズが絶妙に組み合わさり、誰もが笑顔になる一品です。');
...
insert into product values(null, 'フルーツドーナツセット（14個入り）', 4000,'フルーツで飾られた14種類のミニドーナツの盛り合わせです。色とりどりのフルーツがトッピングされたドーナツは、見た目にも楽しく、パーティーや特別なイベントにぴったりのデザートです。');
insert into product values(null, 'ベストセレクションボックス（4個入り）', 1200,'人気商品を集めたこのボックスには、カラフルなスプリンクルと濃厚なチョコレートで飾られた美味しいドーナツが詰まっています。見た目にも楽しく、特別な日のスイーツとして最適です。甘さと食感のバランスが絶妙で、誰もが楽しめる一品です。');
insert into product values(null, 'チョコクラッシュボックス（7個入り）', 2400,'カラフルなスプリンクルと香ばしいナッツがトッピングされた美味しいドーナツが7種詰まっています。見た目にも楽しく、特別な日のスイーツとして最適です。どなたでも楽しめる甘さと食感が魅力の一品です。');
insert into product values(null, 'クリームボックス（4個入り）', 1400,'4個入のボックスは、色とりどりのフロスティングとスプリンクルで飾られた美味しいドーナツが詰まっています。見た目にも楽しく、特別な日のスイーツとして最適です。新鮮な素材を使用し、ふんわりとした食感が特徴です。');
insert into product values(null, 'クリームボックス（9個入り）', 2800,'9個入のボックスは、色とりどりのフロスティングとスプリンクルで飾られた美味しいドーナツが詰まっています。見た目にも楽しく、特別な日のスイーツとして最適です。新鮮な素材を使用し、ふんわりとした食感が特徴です。');
